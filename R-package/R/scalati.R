...
loadData <- function() {
	...
	#	}
		...
		res <- list(d=d, listOfModules=listOfModules, listOfNames=listOfNames, listOfAttrs=listOfAttrs)
	} else {
		   res <- NA
	}
	res
